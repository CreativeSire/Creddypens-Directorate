...
class AgentCatalog(Base):
    ...
    related_agents: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    out_of_scope_examples: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
