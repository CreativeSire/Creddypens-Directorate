  ...
  return (
    <div>
      ...
      {agents.length === 0 ? (
        <EmptyState
          icon={Briefcase}
          title="Department Under Construction"
          description="Agents for this department are currently unavailable. Explore other departments while this unit is being updated."
        />
      ) : (
